...
from nltk_docente_fisi.lexico import lexico_general
...
class VaderConstants:
    ...
    def pairwise_editado(self,iterable):
    ...
    def negated(self, input_words, include_nt=True):
        ...
        if include_nt:
            if any("n't" in word.lower() for word in input_words):
                return True
        for first, second in self.pairwise_editado(input_words):
...
class SentimentIntensityAnalyzer:
    ...
    def __init__(
        ...
        self.lexicon = lexico_general
        self.constants = VaderConstants()


    def puntajes_polaridad(self, text):
        """
